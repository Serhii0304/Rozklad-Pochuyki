...
const files=['index.html','class.html','Розклад дзвінків.html','РОЗКЛАД УРОКІВ Початкові класи.html','index Почуйківська філія квітневого ліцею.html','site.css','enhancements.css','theme-init.js','effects.mjs','schedule-view.mjs','app.mjs','schedule-config.js','time-core.mjs','kyiv-clock.mjs','minute-of-silence.mjs','favicon.svg','school-background-2026.png','THIRD_PARTY_NOTICES.md','Хвилина мовчання.mp3'];
